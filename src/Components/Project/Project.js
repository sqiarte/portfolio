...
function Project () {
    ...
    <div className={style.projectcontainer}>
        ...
        <Cardproject pic={jammmingpic} head={"Jammming"} explain={"A website using Spotify API, let users search for they Spotify playlists and add them to their Spotify accounts."}/>
